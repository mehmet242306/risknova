 ...
 * Kaynak: İçişleri Bakanlığı il/ilçe listesi
 */
...
export const TURKEY_DISTRICTS: Record<string, string[]> = {
  ...
  "Sivas": ["Akıncılar","Altınyayla","Divriği","Doğanşar","Gemerek","Gölova","Güneş","Hafik","İmranlı","Kangal","Koyulhisar","Merkez","Suşehri","Şarkışla","Ulaş","Yıldızeli","Zara"],
...
/** 81 il listesi (alfabetik) */
export const TURKEY_CITIES: string[] = Object.keys(TURKEY_DISTRICTS).sort(
  (a, b) => a.localeCompare(b, "tr")
);

/** Verilen il için ilçe listesi döndür */
