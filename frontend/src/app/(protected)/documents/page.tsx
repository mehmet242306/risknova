export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Doküman Yönetimi</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Doküman oluşturma, AI ile uyarlama, revizyon ve arşiv işlemleri bu alanda yönetilir.</p>
