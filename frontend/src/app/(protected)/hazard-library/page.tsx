export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Tehlike Kütüphanesi</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Sektörlere göre tehlike başlıkları, kontrol maddeleri ve örnek önlemler burada tutulur.</p>
