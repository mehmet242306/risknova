export default function Page() {
  return (
    <div style={{ maxWidth: 900 }}>
      <h1 style={{ fontSize: 26, marginBottom: 8 }}>Fotoğraflı Bulgular</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.6 }}>Fotoğraflarla bulgu arşivi, sınıflandırma ve karşılaştırma.</p>
