export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Risk Analizi</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Risk değerlendirmesi, önlem önerileri ve RHAM tabanlı çalışma akışı bu modülde yer alır.</p>
