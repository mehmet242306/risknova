export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>R-SKOR 2D</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Risk puanlama ve sınıflandırma mantığının gösterildiği hesaplama modülü.</p>
