export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Sağlık Yönetimi</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Sağlık gözetimi planı, muayene takvimi ve sağlık dokümanları için temel yapı.</p>
