export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Tespit ve Öneri</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Sahada bulunan uygunsuzlukların resmi ifade ile kayıt altına alınması ve öneri metinlerinin oluşturulması bu modülde yapılır.</p>
