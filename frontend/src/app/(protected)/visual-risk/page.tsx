export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Görsel Risk Tespiti</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Yüklenen fotoğraflardan risk adaylarını çıkaran ve analiz akışını başlatan ekran.</p>
