export default function Page() {
  return (
    <div style={{ maxWidth: 980 }}>
      <h1 style={{ fontSize: 28, marginBottom: 8 }}>Ayarlar</h1>
      <p style={{ opacity: 0.8, lineHeight: 1.7 }}>Sistem tercihleri, kullanıcı deneyimi ayarları ve organizasyon düzeyi yapılandırmalar.</p>
