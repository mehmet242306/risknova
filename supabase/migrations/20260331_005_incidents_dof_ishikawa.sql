...
create index idx_incidents_company on incidents(company_workspace_id);
...
create index idx_witnesses_incident on incident_witnesses(incident_id);
...
create index idx_dof_incident on incident_dof(incident_id);
create index idx_dof_org on incident_dof(organization_id);
create index idx_dof_status on incident_dof(status);
...
create index idx_ishikawa_incident on incident_ishikawa(incident_id);
