-- ============================================================
-- ISG Document Editor System
-- Tables: document_templates, editor_documents, editor_document_versions
-- (separate from file-based company_documents)
-- ============================================================
...
DROP TRIGGER IF EXISTS set_editor_documents_updated_at ON editor_documents;
...
DROP POLICY IF EXISTS "templates_select_own_org" ON document_templates;
...
DROP POLICY IF EXISTS "templates_insert_own_org" ON document_templates;
...
DROP POLICY IF EXISTS "editor_doc_versions_insert" ON editor_document_versions;
